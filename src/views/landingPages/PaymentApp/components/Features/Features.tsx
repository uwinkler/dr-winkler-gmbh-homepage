...
import Chart2Illustration from 'src/svg/illustrations/Chart2';
import Chart3Illustration from 'src/svg/illustrations/Chart3';
import Chart4Illustration from 'src/svg/illustrations/Chart4';
